      ...
      <div className="relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 md:mx-auto md:flex-row md:items-center">
        ...
        <nav aria-label="Header Navigation" className="peer-checked:mt-8 peer-checked:max-h-56 flex max-h-0 w-full flex-col items-center justify-between overflow-hidden transition-all md:ml-24 md:max-h-full md:flex-row md:items-start">
          <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
            <li className="text-gray-600 md:mr-12 hover:text-blue-600 font-medium"><Link to={`/${props.links[0]}`}>{props.navs[0]}</Link></li>
            <li className="text-gray-600 md:mr-12 hover:text-blue-600 font-medium"><Link to={`/${props.links[1]}`}>{props.navs[1]}</Link></li>
            <li className="text-gray-600 md:mr-12 hover:text-blue-600 font-medium"><Link to={`/${props.links[2]}`}>{props.navs[2]}</Link></li>
            <li className="text-gray-600 md:mr-12 hover:text-blue-600 font-medium"><Link to={`/${props.links[3]}`}>{props.navs[3]}</Link></li>
