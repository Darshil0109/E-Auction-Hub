...
const CardSkeleton = (props) => {
  ...
  <div className="card bg-white p-2 rounded-lg border border-gray-200 hover:border-orange-200 hover:cursor-pointer flex flex-col h-full group animate-pulse">
    {/* Skeleton for Image */}
