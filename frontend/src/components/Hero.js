        ...
        <div className="container mx-auto flex flex-col-reverse   lg:flex-row items-center justify-center px-4">
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <div className="flex justify-center lg:justify-start gap-2 md:gap-4">
              <Link to="/services" className="bg-[#FF6B35] text-white py-3 px-6 rounded hover:bg-[#1A659E] flex items-center space-x-2">
              ...
              <Link to="/products" className="bg-[#004E89] text-white py-3 px-6 rounded hover:bg-[#1A659E] flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
