    ...
    <>
        ...
        <div className='flex flex-col lg:flex-row justify-evenly items-center lg:items-start'>  
            ...
            {filteredproducts.length === 0 ? (
                <div className="flex w-full lg:w-4/5 h-screen justify-center items-center bg-gray-100">
                ...
                <div className="w-full lg:w-4/5 min-h-screen px-4 py-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 sm:gap-3 justify-items-center">
                    {filteredproducts.map((product) => {
                        ...
                        return (
                            <div key={product.id} className="w-full md:w-64">
                                <div className="card h-80 p-2 rounded-lg border border-gray-200 hover:border-orange-200 hover:cursor-pointer flex flex-col justify-evenly group">
