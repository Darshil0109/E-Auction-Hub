            ...
            {!fetched ? <></> :(product.length===0? (
                ...
                <div>
                    <div className='sm:grid grid-cols-1 md:grid-cols-2 grid-rows-3 md:grid-rows-2 gap-4 w-11/12 lg:w-3/4 mx-auto mt-5'>
                        <div className="row-start-1 row-end-2  h-2/3  sm:h-full">
                            <img src={product[0].image_url} alt="img" className=' md:h-full md:w-full max-h-96'/>
                        </div>
                        <div className="grid row-start-2 row-end-5 sm:row-end-4 md:row-start-1 md:row-end-3 md:justify-evenly">
                        <div className='sm:pt-5 sm:px-7 box-border'>
                            <p className='mt-4 text-3xl font-semibold'>{product[0].title}</p>
                            <p className='mt-5 text-lg'>
                                {isReadMore ? product[0].description : `${product[0].description.slice(0, descriptionLimit)}...`}
                                <span
                            ...
                            <div className='mt-5'>
                                ...
                                <div className='flex justify-around flex-wrap w-full'>
                                    <div className='flex flex-col items-center '>
                                        <span className="text-xl sm:text-4xl font-medium"> {days} </span>
                                        <span className='text-sm sm:text-xl font-medium'>Days</span>
                                    </div>
                                    <span className="text-xl sm:text-4xl font-medium"> : </span>
                                    <div className='flex flex-col items-center '>
                                        <span className="text-xl sm:text-4xl font-medium"> {hours} </span>
                                        <span className='text-sm sm:text-xl font-medium'>Hours</span>
                                    </div>
                                    <span className="text-xl sm:text-4xl font-medium"> : </span>
                                    <div className='flex flex-col items-center '>
                                        <span className="text-xl sm:text-4xl font-medium"> {minutes} </span>
                                        <span className='text-sm sm:text-xl font-medium'>Minutes</span>
                                    </div>
                                    <span className="text-xl sm:text-4xl font-medium"> : </span>
                                    <div className='flex flex-col items-center'>
                                        <span className="text-xl sm:text-4xl font-medium"> {remainingSeconds} </span>
                                        <span className='text-sm sm:text-xl font-medium'>Seconds</span>
                                    </div>
                                </div> 
                            </div>
                            ...
                            {(product[0].current_bid) ? (
                                <>
                                    <div className='my-6 flex gap-3 items-center'>Starting Bid:
                                        <p className='sm:text-2xl sm:font-semibold line-through'>₹{product[0].starting_bid}</p>
                                    </div>
                                    <div className='my-2 flex gap-3 items-center'>Current Bid:
                                        <p className='sm:text-3xl sm:font-semibold '>₹{product[0].current_bid}</p>
                                    </div>
                                </>
                            ) : (
                                <>
                                    <div className='my-6 flex gap-3 items-center'>Starting Bid:
                                        <p className='sm:text-2xl sm:font-semibold'>₹{product[0].starting_bid}</p>
                                    </div>
                                </>
                            )}
                                ...
                                <table className="w-full text-sm text-left text-gray-500">
                                    <tbody>
                                        <tr className="border-b border-gray-200">
                                            <td className="px-6 py-4 bg-gray-50">Category</td>
                                            <th scope="row" className="px-6 py-4 font-medium text-gray-900">{categoryName}</th>
                                        </tr>
                                        <tr className="border-b border-gray-200">
                                            <td className="px-6 py-4 bg-gray-50">Seller</td>
                                            <th scope="row" className="px-6 py-4 font-medium text-gray-900">{sellerName}</th>
                                        </tr>
                                        <tr className="border-b border-gray-200">
                                            <td className="px-6 py-4 bg-gray-50">Auction Started At</td>
                                            <th scope="row" className="px-6 py-4 font-medium text-gray-900">{product[0].created_at}</th>
                                        </tr>
                                        <tr className="border-b border-gray-200">
                                            <td className="px-6 py-4 bg-gray-50">Winner</td>
                                            <th scope="row" className="px-6 py-4 font-medium text-gray-900">{winnerName ? winnerName : 'N/A'}</th>
                                        </tr>
                                        <tr className="border-b border-gray-200">
                                            <td className="px-6 py-4 bg-gray-50">Current Bidder</td>
                                            <th scope="row" className="px-6 py-4 font-medium text-gray-900">{bidderName ? bidderName : 'N/A'}</th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
